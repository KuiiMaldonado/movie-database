...
protocol OnTvViewControllerProtocol {
    func getOnTvPrograms()
}

class OnTvViewController: UIViewController {
    var delegate: OnTvViewControllerProtocol!
    //MARK: - Properties
    var models : [TVEntity] = [] {
        didSet {
            loadDataInUI()
...
extension OnTvViewController : UICollectionViewDataSource {
...
extension OnTvViewController : UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        print("CAFV ON TV -> El elemento en la posición \(indexPath.row) fue seleccionado")
    }
}
